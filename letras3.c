...
int letras3(int FPS, int ALTURA, int LARGURA, int pers_sel){
    ...
    al_draw_textf(fonte, al_map_rgb(255, 255, 255), LARGURA * 0.845, ALTURA * 0.705, 0, "FIM");

    al_draw_bitmap(play1, LARGURA * 0.8, ALTURA * 0.8,0);
    al_draw_textf(fonte, al_map_rgb(255, 255, 255), LARGURA * 0.835, ALTURA * 0.805, 0, "MENU");

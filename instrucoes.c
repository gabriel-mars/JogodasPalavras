...
int instrucoes(int FPS, int ALTURA, int LARGURA){
    ...
    al_draw_textf(fonte, al_map_rgb(255, 255,255), LARGURA * 0.21, ALTURA * 0.78, 0, "MENU");
        ...
        while(!al_is_event_queue_empty(fila_eventos)){
            ...
            if(evento.type == ALLEGRO_EVENT_DISPLAY_CLOSE){
                ...
                if(sel1){
                    ...
                    al_draw_textf(fonte, al_map_rgb(255, 255, 255), LARGURA * 0.21, ALTURA * 0.78, 0, "MENU");//Escrevendo a opção no Menu;
                ...
                if(sel2){
                    ...
                    al_draw_textf(fonte, al_map_rgb(255, 255, 255), LARGURA * 0.61, ALTURA * 0.78, 0, "SAIR");//Escrevendo a opção no Menu;
